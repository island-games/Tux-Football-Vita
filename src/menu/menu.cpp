...
void Menu::update(Uint8 *keys)
{
	...
	bool tempDown = false;
		...
		if(playerController != NULL)
		{
			...
			if(playerController->isCrossPressed)
			{
				tempCross = true;
				fprintf(stderr, "\nPress Cross");
			}
